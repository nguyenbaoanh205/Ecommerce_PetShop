...
<link rel="stylesheet" type="text/css" href="{{ asset('public_index/css/vendor.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('public_index/style.css') }}">
...
<body>
    ...
    <script src="{{ asset('public_index/js/jquery-1.11.0.min.js') }}"></script>
    ...
    <script src="{{ asset('public_index/js/plugins.js') }}"></script>
    <script src="{{ asset('public_index/js/script.js') }}"></script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            new Swiper('.products-carousel', {
                ...
                autoplay: {
                    ...
                    disableOnInteraction: false, // vẫn chạy tiếp sau khi người dùng vuốt/chạm
                },
                navigation: {
