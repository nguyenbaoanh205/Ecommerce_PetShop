...
<link rel="stylesheet" type="text/css" href="public_index/css/vendor.css">
<link rel="stylesheet" type="text/css" href="public_index/style.css">
...
<body>
    ...
    <div class="container py-2">
      <div class="row py-4 pb-0 pb-sm-4 align-items-center ">
        ...
        <div class="col-sm-4 col-lg-3 text-center text-sm-start">
          <div class="main-logo">
            <a href="index.html">
              <img src="public_index/images/logo.png" alt="logo" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item1.jpg" class="img-fluid rounded-4" alt="image"></a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item2.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item3.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item4.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item7.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item8.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
    ...
    <div class="container my-5 py-5">
      ...
      <div class="isotope-container row">
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item9.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item10.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item11.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item12.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item13.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item bird col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item14.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item dog col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item15.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
        ...
        <div class="item cat col-md-4 col-lg-3 my-4">
          ...
          <div class="card position-relative">
            <a href="single-product.html"><img src="public_index/images/item16.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-product.html">
                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
              </a>
      ...
      <div class=" swiper bestselling-swiper">
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item5.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
          ...
          <div class="swiper-slide">
            ...
            <div class="card position-relative">
              <a href="single-product.html"><img src="public_index/images/item6.jpg" class="img-fluid rounded-4" alt="image"></a>
              <div class="card-body p-0">
                <a href="single-product.html">
                  <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
                </a>
    ...
    <div class="container py-5 my-5">
      ...
      <div class="row">
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="public_index/images/blog1.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
        ...
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="public_index/images/blog2.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-post.html">
        ...
        <div class="col-md-4 my-4 my-md-0">
          ...
          <div class="card position-relative">
            <a href="single-post.html"><img src="public_index/images/blog3.jpg" class="img-fluid rounded-4" alt="image"></a>
            <div class="card-body p-0">
              <a href="single-post.html">
  ...
  <script src="public_index/js/jquery-1.11.0.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"
    integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"
    crossorigin="anonymous"></script>
  <script src="public_index/js/plugins.js"></script>
  <script src="public_index/js/script.js"></script>
