            ...
            <div class="products-carousel swiper">
              ...
              New
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="card position-relative">
                            <a href="single-product.html"><img src="public_index/images/item3.jpg"
                                    class="img-fluid rounded-4" alt="image"></a>
                            <div class="card-body p-0">
                                <a href="single-product.html">
                                    <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
        ...
        <div class="container my-5 py-5">
            ...
            New
                ...
                <div class="item dog col-md-4 col-lg-3 my-4">
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="public_index/images/item10.jpg"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
            ...
            New
                ...
                <div class="item cat col-md-4 col-lg-3 my-4">
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="public_index/images/item12.jpg"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
            ...
            New
                ...
                <div class="item dog col-md-4 col-lg-3 my-4">
                    ...
                    <div class="card position-relative">
                        <a href="single-product.html"><img src="public_index/images/item15.jpg"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-product.html">
                                <h3 class="card-title pt-4 m-0">Grey hoodie</h3>
        ...
        <div class="container py-5 my-5">
            ...
            <div class="row">
                ...
                <div class="col-md-4 my-4 my-md-0">
                    ...
                    <div class="card position-relative">
                        <a href="single-post.html"><img src="public_index/images/blog2.jpg"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-post.html">
                ...
                <div class="col-md-4 my-4 my-md-0">
                    ...
                    <div class="card position-relative">
                        <a href="single-post.html"><img src="public_index/images/blog3.jpg"
                                class="img-fluid rounded-4" alt="image"></a>
                        <div class="card-body p-0">
                            <a href="single-post.html">
